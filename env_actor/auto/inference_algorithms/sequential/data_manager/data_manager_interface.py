class DataManagerInterface:
    def __init__(self, runtime_params, robot):
        ...
        if robot == "igris_b":
            from env_actor.auto.inference_algorithms.sequential.data_manager.igris_b.data_manager_bridge import DataManagerBridge
        elif robot == "igris_c":
            from env_actor.auto.inference_algorithms.sequential.data_manager.igris_c.data_manager_bridge import DataManagerBridge
