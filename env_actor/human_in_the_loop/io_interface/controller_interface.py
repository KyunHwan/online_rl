class ControllerInterface:
    def __init__(self, 
        ...
        if robot == "igris_b":
            from env_actor.human_in_the_loop.io_interface.igris_b.controller_bridge import ControllerBridge
        elif robot == "igris_c":
            from env_actor.human_in_the_loop.io_interface.igris_c.controller_bridge import ControllerBridge
